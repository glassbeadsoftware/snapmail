...
import {CAN_DM, CHUNK_MAX_SIZE, DIRECT_SEND_CHUNK_TIMEOUT_MS, DIRECT_SEND_TIMEOUT_MS, Directory, FILE_MAX_SIZE, REMOTE_ENDPOINT, ZOME_NAME, DeliveryState, DirectMessageProtocol, InMailState, LinkKind, MailState, OutMailState, RecipientKind, SignalProtocol, SnapmailEntry, AckMessage, AttachmentInfo, CommitPendingAckInput, CommitPendingMailInput, DeliveryConfirmation, DmPacket, FileChunk, FileManifest, FindManifestOutput, GetMailOutput, GetMissingAttachmentsInput, GetMissingChunksInput, Handle, HandleItem, InAck, InMail, Mail, MailItem, MailMessage, OutAck, OutMail, PendingAck, PendingMail, PubEncKey, ReceivedAck, SendMailInput, WriteManifestInput, ZomeManifestVec, } from './snapmail.types';
import {
/** types.ts */
HoloHash,
AgentPubKey,
